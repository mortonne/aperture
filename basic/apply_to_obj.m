...
%  immediately update the parent object with the modified child.  For example,
%  you might want to modify a pat object, then update it's parent subj
%  object.
%
%  INPUTS:
%           s:  a structure
...
%               subfield of s.
%
%    obj_name:  the string identifier for the object that you want to modify;
%               this should be the same as the "name" field of the object.
%
%  fcn_handle:  handle to a function to input the object.  The first input
%               should be the object, and the first output should be an object
%               of the same type.
%
%  fcn_inputs:  a cell array of additional inputs to fcn_handle (the object
%               is the first input).
%
%  OUTPUTS:
%       s_out:  same a s, but the object specified by obj_type and obj_name
%               is modified.
%
%  EXAMPLES:
